import { AiFillCloseCircle, AiOutlineHistory } from "react-icons/ai";
...
function Inventory() {
    ...
    return (
        <>
                        ...
                        {inventory.map((inventory, index) => {
                            ...
                            return (
                                <tr key={index}>
                                    ...
                                    <Td>
                                        <button className="bg-red-600 hover:bg-red-700 p-2 px-4 m-2 rounded-full text-white flex items-center justify-center">
                                            <span>
                                                <AiFillCloseCircle />
                                            </span>
            ...
            {showAddInventory && <AddInventory toggleAddInventory={() => { setShowAddInventory(!showAddInventory) }}
